let getAncestors = function(n, edges) {
    ...
    for (let i=0; i<n; i++)
    {
        ...
        while (stack.length > 0)
        {
            ...
            {
                if (!(result[nodes].includes(i)))
                {
                    result[nodes].push(i);
                    result[nodes].push(...ancestors[nodes]);
                }
